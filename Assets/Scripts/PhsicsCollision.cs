...
public class PhysicsCollision : NetworkBehaviour
{
    ...
    void OnCollisionStay(Collision other)
    {
        if (other.gameObject.CompareTag("Player"))
        {
            ...
            {
                Debug.Log("PhysicsCollision OnCollisionStay>>" + other.gameObject.GetComponent<NetworkIdentity>().connectionToClient.connectionId + "," + NetworkConnection.LocalConnectionId);
