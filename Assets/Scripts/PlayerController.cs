...
public class PlayerController : NetworkBehaviour
{
    ...
    {
        Debug.Log("PlayerController OnValiate>>");
        base.OnValidate();
    ...
    {
        Debug.Log("PlayerController OnStartAuthority>>");
    ...
    {
        Debug.Log("PlayerController OnStopAuthority>>");
        this.enabled = false;
        characterController.enabled = false;
    }
    ...
    void HandleTurning()
    {
        ...
        //Debug.Log("PlayerController HandleTurning>>"+ turnSpeed);
    ...
    void HandleJumping()
    {
       ...
       // Debug.Log("PlayerController HandleJumping>>" + jumpSpeed+"groundState>"+ groundState);
    ...
    void HandleMove()
    {
       ...
       // Debug.Log("PlayerController HandleMove>>" + jumpSpeed + "groundState>" + groundState);
    }
}